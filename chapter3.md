...
(5) The notification shall entitle the data intermediary to provide data sharing services in all Member States.

(6) The notification shall include the following information:

(a) the name of the data intermediary;

(b) the data intermediary’s legal status, form and registration number, where the provider is registered in trade or in another similar public register;
...
(1) the data intermediary shall use the data for which it provides services only in the contexxt of the provision of services referred to in Article 9(1); those data sharing services shall be placed in a separate legal entity;

(2) the metadata collected from the provision of the data sharing service shall be used only for the development of that service, which may entail the use of metadata for the detection of fraud or cybersecurity threat monitoring, and should be made available to the data holders upon request3;
...
(3) The designated competent authorities, the data protection authorities, the national competition authorities, the authorities in charge of cybersecurity, and other relevant sectorial authorities shall build up a trong cooperation and exchange the information which is necessary for the exercise of their tasks in relation to data intermediaries, and ensure consistency of the decisions taken in application of this directive.

### Article 13 Monitoring of compliance

(1) The competent authority shall monitor and supervise compliance with this Chapter.

(2) The competent authority shall have the power to request from data intermediaries or their legal represetatives all the information that is necessary to verify compliance with the requirements laid down in Articles 10 and 11. Any request for information shall be proportionate to the performance of the task and shall be reasoned.
...
(b) to require postponement or cessation of the provision of the data sharing service, the latter in case where serious breaches have not been addressed, despite being previously identified and communicated;
